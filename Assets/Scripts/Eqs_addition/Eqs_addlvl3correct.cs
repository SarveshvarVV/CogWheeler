...
public class Eqs_addlvl3correct : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        levelCount = Eqs_addlvl3manager.levelCount;
        elapsedTime = Eqs_addlvl3manager.elapsedTime;
        ...
        scorenewval = Eqs_addlvl3manager.scoreval;
    ...
    void Update()
    {
        //rightval = Eqs_addlvl3manager.right;
        //rightdis.text = "Correct:" + rightval.ToString();
        //failval = Eqs_addlvl3manager.fail;
