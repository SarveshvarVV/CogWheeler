...
public class Eqs_sub2correct : MonoBehaviour
{
    ...
    void Start()
    {
        levelCount = Eqs_sub2manager.levelCount;
        elapsedTime = Eqs_sub2manager.elapsedTime;
        ...
        scorenewval = Eqs_sub2manager.scoreval;
    ...
    void Update()
    {
        //rightval = Eqs_sub2manager.right;
        //rightdis.text = "Correct:" + rightval.ToString();
        //failval = Eqs_sub2manager.fail;
